...
List<Book> books = [
  ...
  Book(
    ...
    description:
        ' "Harry Potter and the Prisoner of Azkaban" is the third book in the Harry Potter series written by J.K. Rowling, following the adventures of young wizard Harry Potter and his friends Ron Weasley and Hermione Granger, as they confront a dangerous escaped prisoner and unravel a complex web of secrets and betrayal at the Hogwarts School of Witchcraft and Wizardry. ',
  ),
  Book(
